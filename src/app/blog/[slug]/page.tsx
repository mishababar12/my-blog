...
const BlogPost = () => {
  const { slug } = useParams(); // Use useParams to get the dynamic parameter from the URL
...
<br/><p><strong>Have any favorite winter skincare products of your own? Feel free to share them in the comments below!</strong></p>
    ...
    },
    {
      ...
      image: "/avo.jpeg",
      content: `
        <p><strong>Here Are Common Skincare Mistakes to Avoid:</strong></p><br/>
...
<ul>
    ...
    <br/><li><strong>Not Drinking Enough Water:</strong> Hydration is essential not just for your body but also for your skin. Dehydrated skin appears dull, feels rough, and can accentuate the appearance of fine lines and wrinkles. It's important to nourish your skin from the inside out.
     ...
     <br/><li><strong>Skipping Moisturizer:</strong> Moisturizing your skin is essential to maintain its balance. Many people skip moisturizer thinking it might make their skin oily, but this can actually worsen dry skin and lead to irritation. Proper moisturizing helps lock in hydration, keeping your skin soft and smooth.
...
<br/><p><strong>Have any questions or other skincare tips to share? Feel free to leave a comment below!</strong></p>
    ...
    },
    {
      ...
      image: "/bestt.jpeg",
      content: `
       Eat Your Way to Better Skin with These Healthy Foods: <p><br/><strong> A Perfect Skin Diet:</strong></p>
...
<br/><p><strong> Omega-3 Fatty Acids:</strong></p>
<ul>
...
<br/><p><strong>Vitamin C:</strong></p>
<ul>
...
<br/><p><strong>Antioxidants:</strong></p>
<ul>
...
<br/><p><strong>Bonus Tips for Glowing Skin:</strong></p>
<ul>
...
<br/><p><strong>Have any questions or tips for achieving glowing skin? Feel free to share your thoughts in the comments below!</strong></p>
        ...
        <ul> <br/><li><strong>Use a Gel-Based Cleanser:</strong> <p>Choosing the right cleanser is crucial for oily skin. Harsh cleansers may strip away too much oil, which can cause the skin to overcompensate by producing even more oil. A gel-based cleanser is perfect for oily skin as it helps to remove excess oil without drying out the skin. Gel cleansers are generally lightweight, non-comedogenic (won’t clog pores), and gentle on the skin while still effectively cleansing and balancing oil production.</p>
         ...
         <p><strong>Personal Tip:</strong> Avoid cleansers with high alcohol content, as they can cause your skin to dry out and stimulate more oil production. Look for ingredients like salicylic acid or tea tree oil for extra oil-fighting benefits.</p> </li> <br/><li><strong>Exfoliate Regularly:</strong> <p>Exfoliation is essential for removing dead skin cells that can clog pores and cause breakouts. It also helps to control excess oil, leaving your skin feeling smoother and more balanced.
          ...
          Carry them with you to tackle any shine that appears, especially in areas like the forehead, nose, and chin (the T-zone), which are more prone to oil production.</p> <p><strong>How to Use:</strong> Gently press the blotting paper on areas of your face where excess oil has built up. You don’t need to rub or scrub—just lightly dab it onto the skin to absorb oil. Use blotting papers throughout the day as needed to maintain a fresh, shine-free complexion without drying out your skin.</p> <p><strong>Personal Tip:</strong> Blotting papers are not a substitute for proper skincare; they’re meant for quick fixes when you’re on the go. Be sure to maintain a consistent skincare routine at home.</p> </li> </ul> <p>By following these steps—using a gel-based cleanser, exfoliating regularly, moisturizing, and carrying blotting papers—you can better manage oily skin,
           control excess shine, and prevent breakouts. The key is to balance oil production while ensuring your skin remains hydrated and healthy. Keep experimenting with products that suit your skin's needs, and remember that consistency is key to achieving the best results.</p> <br/><p><strong>Feel free to share your own tips for managing oily skin in the comments below! How do you keep your skin balanced and healthy?</strong></p>
      `,
    },
    {
...
return (
  <div className="bg-gradient-to-r from-lime-100 via-fuchsia-200 py-16 px-6">
    <div className="max-w-7xl mx-auto">
      {/* Main Post Content */}
      <div className="flex justify-center items-center flex-col">
        <div className="w-full max-w-2xl h-full mt-6 bg-pink-100 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
          <Image
            src={post.image}
            alt={post.title}
            width={1000}
        ...
        <div className="mt-16 text-pink-500" dangerouslySetInnerHTML={{ __html: post.content }} />

        {/* Comments Section */}
        <div className="mt-12 w-full max-w-2xl p-6 bg-pink-100 mr-auto rounded-lg shadow-lg"> 
          <h3 className="text-xl font-semibold text-pink-500 mb-4">Comments</h3>
          ...
          <form onSubmit={handleCommentSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 bg-pink-400 text-white font-semibold rounded-md hover:bg-pink-700"
            >
              Post Comment
            </button>
          </form>
          ...
          <div className="mt-2 space-y">
            {comments.map((comment) => (
              <div key={comment.id} className="p-4 border border-gray-200 rounded-md">
                <strong className="text-pink-700">{comment.name}</strong>
                <p className="text-pink-700">{comment.text}</p>
              </div>
            ))}
          </div>
        </div>
